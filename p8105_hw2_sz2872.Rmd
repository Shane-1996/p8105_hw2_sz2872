...
The proportion of station entrances / exits without vending allow entrance is `r transit_df %>% filter(entry == TRUE, vending == "NO") %>% nrow() / transit_df %>% filter(entry == TRUE) %>% nrow()`.
